		...
		if ifirst[j] != -1:
			...
			if len(avspeed[j])>4:
				for i in range(len(acspeed[j])-1):
					...
					formula=8.692*10**(-5)*((length[j][0])**2)*(((acspeed[j][i+1]+acspeed[j][i])*1.852/2)**3)*(interval[j][i+1]-interval[j][i])*c*(15.7*0.027+11.7*0.834+10.6*0.139)*0.9*0.98/3600
