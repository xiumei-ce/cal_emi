		...
		if ifirst[j] != -1:
			...
			if len(acspeed[j])>4:
				for i in range(len(acspeed[j])-1):
					...
					formula=4.755*10**(-5)*((ship_length[i])**2)*(((acspeed[j][i+1]+acspeed[j][i])*1.852/2)**3)*(interval[j][i+1]-interval[j][i])*c*1.03*0.47*0.98/3600
