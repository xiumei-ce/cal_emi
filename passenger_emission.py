		...
		if ifirst[j] != -1:
			...
			if len(acspeed[j])>4:
				for i in range(len(acspeed[j])-1):
					...
					formula=4.26*10**(-5)*((length[j][0])**2)*(((acspeed[j][i+1]+acspeed[j][i])*1.852/2)**3)*(interval[j][i+1]-interval[j][i])*c*(16.3*0.009+12.3*0.731+10.6*0.26)*0.9*0.98/3600
